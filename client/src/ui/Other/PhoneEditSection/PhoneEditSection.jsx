...
import { formatPhoneFromInternational } from "../../../utils/index.js";
...
const PhoneEditSection = ({ user, inputClassNames }) => {
	...
	return (
		<>
			<PhoneInput
				...
				className={inputClassNames.phoneInput}
			/>
			...
			{showCodeInput && (
				<CodeInput
					...
					className={inputClassNames.codeInput}
				/>
			)}
		</>
	);
